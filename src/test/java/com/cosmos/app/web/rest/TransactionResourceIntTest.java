...
public class TransactionResourceIntTest {
    ...
    private static final Integer DEFAULT_FUEL_VOLUME = 1;
    private static final Integer UPDATED_FUEL_VOLUME = 2;
    ...
    public void createTransaction() throws Exception {
        ...
        assertThat(testTransaction.getFuelVolume()).isEqualTo(DEFAULT_FUEL_VOLUME);
    ...
    @Test
    @Transactional
    public void checkFuelVolumeIsRequired() throws Exception {
        int databaseSizeBeforeTest = transactionRepository.findAll().size();
        // set the field null
        transaction.setFuelVolume(null);
    ...
    public void updateTransaction() throws Exception {
        ...
        assertThat(testTransaction.getFuelVolume()).isEqualTo(UPDATED_FUEL_VOLUME);
